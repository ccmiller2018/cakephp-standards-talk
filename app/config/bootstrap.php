...
*/
if (!(bool)env('APP_NAME') && file_exists(CONFIG . '.env')) {
 ...
 */
ServerRequest::addDetector('mobile', function (): bool {
    $detector = new \Detection\MobileDetect();

    return $detector->isMobile();
});
ServerRequest::addDetector('tablet', function (): bool {
    $detector = new \Detection\MobileDetect();
